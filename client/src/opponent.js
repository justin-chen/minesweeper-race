...
class Opponent extends Component {
    ...
    componentDidMount() {
        this.socket.on('mine-opponent', function (mine_coords, x, y) {
        ...
        this.socket.on('new-game-opponent', function () {
            board.restart(this);
        }.bind(this));

        this.socket.on('get-reveal-neighbours-opponent', function (x, y) {
            var flag_array = [];
